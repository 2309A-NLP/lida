"""
Embedding模块 - ONNX本地推理，无需multiprocessing
"""
import os
...
class Embedder:
    """向量编码器，基于本地ONNX模型，无multiprocessing依赖"""
